...
import {
  useCategorias,
  useDashboard,
  useDetidoEstatisticas,
  useDiligenciaEstatisticas,
  useDireccoes,
  usePatentes,
  useProcessoEstatisticas,
  useTiposCrimes,
  ...
  return (
    <section aria-labelledby="overview-title">
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-4">
        <KpiCard
          title="Processos"
          value={processoData.total || 0}
          icon={FileText}
          color="bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400"
          description="Total"
          isLoading={processoStats.isLoading}
        />
        <KpiCard
          title="Em Instrução"
          value={processoData.emInstrucao || 0}
          icon={Clock}
        ...
        <KpiCard
          title="Arquivados"
          value={processoData.arquivados || 0}
          icon={Archive}
        ...
        <KpiCard
          title="Remetidos"
          value={
            (processoData.remetidoJuizo || 0) + (processoData.remetidoPGR || 0)
          }
          icon={Send}
        ...
        <KpiCard
          title="Sentenciados"
          value={processoData.sentenciados || 0}
          icon={Gavel}
        ...
        <KpiCard
          title="Com Detido"
          value={processoData.comDetido || 0}
          icon={AlertTriangle}
        ...
        <KpiCard
          title="Mandados"
          value={dashboardData?.estatisticasMandato?.total || 0}
          icon={Scale}
        ...
        <KpiCard
          title="Detidos"
          value={detidoData.total || 0}
          icon={UserRound}
          color="bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400"
          isLoading={detidoStats.isLoading}
        />
