    ...
    <div className="rounded-2xl bg-muted/30 p-4 lg:p-8">
      <div className="mx-auto min-h-[1123px] w-full max-w-[794px] bg-white p-12 text-black shadow-lg font-serif">
        ...
        <div className="mt-8 text-[14px] leading-relaxed text-justify space-y-6">
          ...
          <p>
            Em seguida encaminhou-se a pessoa de proceder a identificação a sala
            própria para o efeito, onde se encontrava o objecto a identificar
            sinalizado com o número
            <strong> {emptyLine(preview?.numeroSinalizacao, 10)}</strong>, entre
            outros semelhantes ou parecidos.
          </p>

          <p>
            Na sequência o identificador após ter olhado atentamente e no tempo
            que achou conveniente disse:
          </p>
