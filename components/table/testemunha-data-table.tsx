...
const columns: ColumnDef<TestemunhaListItem>[] = [
  {
    id: "nomeCompleto",
...
interface Props {
  promise: Promise<TestemunhaListItem[]>;
}

export function TestemunhaDataTable({ promise }: Props) {
  ...
  return (
    <>
      ...
      <AddTestemunhaModal open={openModal} setOpen={setOpenModal} />
    </>
  );
}
